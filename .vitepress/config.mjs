...
export default defineConfig({
  ...
  themeConfig: {
    ...
    // 底部备案信息
    footer: {
      copyright: `Copyright © 2024-${new Date().getFullYear()} Orange`,
    },
